...
public class Main {
	 ...
	 * Cette application permet de gerer un aeroport. Elle met l'utilisateur a la place d'un controleur aerien.
	 * Apres avoir renseigne le nombre de pistes que l'aeroport possede, plusieurs avions apparaissent dans les radars 
	 * et l'utilisateur gere leur atterrissages. Il est aussi en charge du remplissage des avions et de leur decollage.
	 * Le remplissage de chaque avion present "sur le tarmac" depend des personnes presente dans l'aeroport.
	 ...
	 * L'atterrissage se gere de la meme fa�on : l'utilisateur peut gerer les priorites d'atterrissages de maniere automatique.
	 * Il peut aussi consulter l'etat des avions, des passagers et de toutes les entites en attente dans son aeroport.
	 * L'application se deroule sous formes d'intervalles d'actions. Il y a en tout 7 actions � chaque "tour" de jeu qui se repeteront.
